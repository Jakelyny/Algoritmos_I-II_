...
/*Crie um programa para controlar o estoque de uma empresa, sabendo que serão no máximo 50 produtos, o sistema deverá manipular o
código do produto, nome, unidade, valor de venda e quantidade em estoque. O sistema deverá apresentar um menu com as seguintes opções:
0 – Sair
1 – Cadastrar produto
2 – Listar produtos cadastrados
3 – Consultar produto pelo código
4 – Vender produto (fornece o código e a quantidade de venda, o sistema verifica se existe estoque suficiente e executa a venda atualizando
